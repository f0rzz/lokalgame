  ...
  @csrf
    ...
    <div class="mb-4">
      ...
      @enderror
        ...
        <div class="mb-4">
            <label class="block mb-2 text-sm font-medium text-gray-800 dark:text-white" for="cover">Upload Cover</label>
            <input class="@error('cover') bg-red-50 border-red-500 text-red-700 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="cover_help" id="cover" type="file" name="cover" accept="image/png, image/jpeg, image/jpg">
